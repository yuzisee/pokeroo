...
{//NO ASSIGNMENT OPERATOR
    ...
    public:
        static float64 dfacedOdds_raise_dfacedBet_GeomDEXF(const ExpectedCallD &tbase, const struct HypotheticalBet & hypothetical, float64 w, const float64 dRiskLoss_dfacedBet);
