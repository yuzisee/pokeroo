...
///Update cache
	...
	const float64 opponents = tableinfo->handsToBeat(); // The number of "opponents" that people will think they have (as expressed through their predicted showdown hand strength)
