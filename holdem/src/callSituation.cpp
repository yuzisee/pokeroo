...
float64 ExpectedCallD::foldGain(const float64 mean)
{
    return foldGain(mean,0,callBet());
}

float64 ExpectedCallD::foldGain(const float64 mean, const float64 extra, const float64 facedBet)
{
