...
\end{itemize}
Also considered is the probability of improving the betting situation for the next betting round, as well as best-case and worst-case $\mathrm{Pr_\{win\}}$ estimates.
...
Figure~\ref{fig:Cumu} provides a sample \texttt{CallStats} cumulative histogram plotted from real simulation data.
...
See Figure~\ref{fig:Pr} for example $\mathrm{Pr\{push\}}$ behaviour plotted from real simulation data.
