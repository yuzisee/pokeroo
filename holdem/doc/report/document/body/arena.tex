...
\begin{figure}[htb]
 ...
 \end{center}
 \caption[Sample Cumulative Histograms]{ The pre-flop CommunityCallStats cumulative histogram and the pre-flop CallStats histogram of a player holding a pair of nines.}
 \label{fig:Cumu}
\end{figure}
